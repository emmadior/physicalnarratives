...
/**
 * Fallback blobs when CMS data has not loaded. Each cluster extent is derived
 * from its maxRadius.
 */
const blobDefaults = [
  {
    video: "/videos/video1.mp4",
    videoFull: "/videos_full/video1.mp4",
    circleCount: 22,
    minRadius: 60,
    maxRadius: 130,
    videoOpacity: 1.0,
  ...
  },
  {
    ...
    videoFull: "/videos_full/video2.mp4",
    circleCount: 22,
    minRadius: 60,
    maxRadius: 130,
    videoOpacity: 1.0,
  ...
  },
  {
    ...
    videoFull: "/videos_full/video3.mp4",
    circleCount: 22,
    minRadius: 60,
    maxRadius: 130,
    videoOpacity: 1.0,
  ...
  },
  {
    ...
    videoFull: "/videos_full/video4.mp4",
    circleCount: 22,
    minRadius: 60,
    maxRadius: 130,
    videoOpacity: 1.0,
...
export const PARAMS = {
  ...
  interfaceWidth: 1.0,
  videoStretch: true, // fill the live silhouette (same idle and selected)
  videoFitPadding: 1.12, // frame padding around the rest silhouette
  blobColor: "#b2b2b2", // fallback fill under the video
  ...
  scrollRange: 1400,
  /** Height of the rising text block used for collision, CSS px. */
  scrollTextHeight: 280,
  /** Smoothing time for scroll-driven breaker motion. */
  scrollSmoothSeconds: 0.16,

  /** Fallback layout-px radius when the info block has not been measured. */
  breakerRadius: 108,
  /** Extra radius as a fraction of the focused blob's smaller layout axis. */
  breakerRadiusScale: 0,
  /** Invisible collider width as a multiple of its height (2 = twice as wide). */
  breakerWidthScale: 2.5,
