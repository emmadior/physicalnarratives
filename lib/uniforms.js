...
export const PARAMS = {
  /**
   * Multiplies LAYOUT_REFERENCE — higher = zoomed-out stage. Set from
   * project count so more blobs get more negative space (1 = no boost).
   */
  populationLayoutBoost: 1,
  ...
  blobColor: "#9749e5", // fallback fill under the video
