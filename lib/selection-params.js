...
/** @deprecated prefer PARAMS.focusOverlapTarget */
export const SELECTED_OVERLAP = 0.62;
/** @deprecated prefer PARAMS.focusRepulsion */
export const SELECTED_REPULSION = 2.8;
...
/** @param {ReturnType<typeof captureParamSnapshot>} snap @param {number} _index */
export function selectedParamTarget(snap, _index) {
  return {
    overlapTarget: snap.overlapTarget,
    repulsion: snap.repulsion,
    blobs: snap.blobs.map((b) => ({ ...b })),
  };
}
